...
public class Order {
    ...
    // map the row of data from ResultSet to an Order object with a Customers object
    // as its associated customer
    ...
    // JSON object used to serialize the Order object to JSON format
